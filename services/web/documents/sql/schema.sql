...
CREATE TABLE IF NOT EXISTS `t_projects_settings` (
  ...
  `id_test_dc_state` int(11) NOT NULL COMMENT 'Test (Default) Created State Code',
  `id_test_dud_state` int(11) NOT NULL COMMENT 'Test (Default) Under Development State Code',
  `id_test_dr_state` int(11) NOT NULL COMMENT 'Test (Default) Ready State Code',
  `id_set_dc_state` int(11) NOT NULL COMMENT 'Set (Default) Created State Code',
  `id_set_dud_state` int(11) NOT NULL COMMENT 'Set (Default) Under Development State Code',
  `id_set_dr_state` int(11) NOT NULL COMMENT 'Set (Default) Ready State Code',
  `id_run_dc_state` int(11) NOT NULL COMMENT 'Run (Default) Created State Code',
  `id_run_dud_state` int(11) NOT NULL COMMENT 'Run (Default) Under Development State Code',
  `id_run_dr_state` int(11) NOT NULL COMMENT 'Run (Default) Ready State Code',
  `id_run_drns_state` int(11) NOT NULL COMMENT 'Run (Default) Not Started State Code',
  `id_run_drip_state` int(11) NOT NULL COMMENT 'Run (Default) In Progress State Code',
  `id_run_drc_state` int(11) NOT NULL COMMENT 'Run (Default) Completed State Code',
...
CREATE TABLE IF NOT EXISTS `t_runs` (
  ...
  `state` int(11) NOT NULL COMMENT 'Current Development State (CREATED, RUNNING, FINISHED)',
...
CREATE TABLE IF NOT EXISTS `t_playlists` (
  ...
  `run_code` int(11) NOT NULL COMMENT 'Result Code for Run',
...
CREATE TABLE IF NOT EXISTS `t_states` (
  ...
  `type` int(11) NOT NULL COMMENT 'State Type (1 - State, 2 - Run State)',
  ...
  `dt_modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `IU_STATE_I18N` (`id_i18n`,`type`,`code`),
