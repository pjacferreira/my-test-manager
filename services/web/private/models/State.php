...
class State extends \api\model\AbstractEntity {
  ...
  public function initialize() {
    // Define Relations
    // A Single User can Be the Creator for Many States
    $this->hasMany("id", "User", "creator");
    // A Single User can Be the Modifier for Many States
  ...
  /**
   * Define alternate table name for states
   * 
   * @return string States Table Name
   */
