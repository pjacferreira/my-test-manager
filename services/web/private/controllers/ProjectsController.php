...
class ProjectsController extends CrudServiceController {
  ...
  public function create($name) {
    ...
    $context = $context
            ->setIfNotNull('project:name', StringUtilities::nullOnEmpty($name));
  ...
  public function deleteByName($name) {
    ...
    $context = new ActionContext('delete');
    // Call Action
    return $this->doAction($context->setIfNotNull('project:name', StringUtilities::nullOnEmpty($name)));
  }
  ...
  protected function preActionDelete($context) {
    ...
    \UserProject::deleteRelationsProject($project);
  ...
  protected function preAction($context) {
    ...
    $context = $this->onParameterDo($context, 'organization:id', function($controller, $context, $action, $value) {
      ...
      return $context->setParameter('project:organization', $org);
    ...
    $context = $this->onParameterDo($context, 'project:name', function($controller, $context, $action, $value) {
      ...
      $project = \Project::findFirstByName($value);
  ...
  protected function postActionCreate($context) {
    ...
    \UserProject::addRelation($user, $project);
   ...
   * 
   * @return \Project An instance of a Project Entity, managed by this controller
   */
