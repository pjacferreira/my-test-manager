...
class UserProjectController extends BaseServiceController {
  ...
  protected function doLinkAction($context) {
    return \models\UserProject::addRelation(
  ...
  protected function doUnlinkAction($context) {
    ...
    $link = \models\UserProject::deleteRelation($user, $project);
    if (!isset($link)) { // NO
  ...
  protected function doListUsersAction($context) {
    return \models\UserProject::listUsers($context->getParameter('project'));
  }
  ...
  protected function doCountUsersAction($context) {
    return \models\UserProject::countUsers($context->getParameter('project'));
  }
  ...
  protected function doListProjectsAction($context) {
    return \models\UserProject::listProjects($context->getParameter('user'));
  }
  ...
  protected function doListProjectsPermissionsAction($context) {
    return \models\UserProject::listProjectPermissions($context->getParameter('user'));
  }
  ...
  protected function doCountProjectsAction($context) {
    return \models\UserProject::countProjects($context->getParameter('user'));
  }
