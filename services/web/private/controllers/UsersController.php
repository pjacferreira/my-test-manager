...
class UsersController extends CrudServiceController {
  ...
  public function create($name) {
    ...
    // Call Action
    return $this->doAction($context->setIfNotNull('user:name', StringUtilities::nullOnEmpty($name)));
  }
  ...
  protected function preActionDelete($context) {
    ...
    \UserProject::deleteRelationsUser($user);
    \UserOrganization::deleteRelationsUser($user);
  ...
  protected function preAction($context) {
    ...
    $context = $this->onParameterDo($context, 'user:name', function($controller, $context, $action, $value) {
      ...
      $user = \User::findFirstByName($value);
    ...
    $context = $this->onParameterDo($context, 'user:password', function($controller, $context, $action, $value) {
      ...
      $password = StringUtilities::nullOnEmpty($value);
   ...
   * 
   * @return \User An instance of a User Entity, managed by this controller
   */
