...
class BaseController extends Controller {
  ...
  protected function renderJson($context) {
    ...
    if (isset($results)) {
      $response = $this->sharedViews->render('service-response.json', array('results' => $results));
    } else {
      $response = $this->sharedViews->render('service-response.json');
    }
  ...
  protected function renderExceptionJson($context) {
    ...
    $response = $this->sharedViews->render('service-response.json', array(
