...
class ProjectsController extends CrudServiceController {
  ...
  public function deleteByNameAction($name) {
    ...
    $context = new ActionContext('delete');
    // Call Action
    return $this->doAction($context->setIfNotNull('name', StringUtilities::nullOnEmpty($name)));
  }
   ...
   * @return type
   */
  public function listAction(Request $request, $filter = null, $sort = null, $limit = null) {
    // Create Action Context
    $context = new ActionContext('list');
    // Build Parameters
    $context = $context
            ->setFirstNotNullOf('__filter', StringUtilities::nullOnEmpty($filter), $request->request->get('filter'))
            ->setFirstNotNullOf('__sort', StringUtilities::nullOnEmpty($sort), $request->request->get('sort'))
            ->setFirstNotNullOf('__limit', StringUtilities::nullOnEmpty($limit), $request->request->get('limit'));
  ...
  public function countAction(Request $request, $filter = null) {
    ...
    // Build Parameters
    $context = $context->setFirstNotNullOf('__filter', StringUtilities::nullOnEmpty($filter), $request->request->get('filter'));
   ...
   * @return type
   */
  public function listOrganizationAction(Request $request, $org_id = null, $filter = null, $sort = null, $limit = null) {
    ...
    // Create Action Context
    $context = new ActionContext('list_organization');
    // Build Parameters
    $context = $context
            ->setFirstNotNullOf('__filter', StringUtilities::nullOnEmpty($filter), $request->get('filter'))
            ->setFirstNotNullOf('__sort', StringUtilities::nullOnEmpty($sort), $request->get('sort'))
            ->setFirstNotNullOf('__limit', StringUtilities::nullOnEmpty($limit), $request->get('limit'))
   ...
   * @return type
   */
  public function countOrganizationAction(Request $request, $org_id = null, $filter = null) {
    // Create Action Context
    $context = new ActionContext('count_organization');
    // Build Parameters
    $context = $context
            ->setFirstNotNullOf('__filter', StringUtilities::nullOnEmpty($filter), $request->get('filter'))
            ->setIfNotNull('org_id', isset($org_id) ? (integer) $org_id : null);
  ...
  protected function postActionCreate($context) {
    ...
    $container = $repository->createContainer("ROOT Project [{$project->getId()}]", $project);
   ...
   * @return mixed
   */
  protected function doListOrganizationAction($context) {
   ...
   * @return int
   */
  protected function doCountOrganizationAction($context) {
    // Get the Organization
    $organization = $context->getParameter('organization');
  ...
  protected function sessionChecks($context) {
    ...
    $context = $this->onParameterDo($context, 'org_id', function($controller, $context, $action, $value) {
            ...
            }, null, array('Create', 'ListOrganization', 'CountOrganization'), function($controller, $context, $action) {
    ...
    $context = $this->onParameterDo($context, 'name', function($controller, $context, $action, $value) {
    ...
    if (!$context->hasParameter('entity')) {
      $context = $this->onParameterDo($context, 'id', function($controller, $context, $action, $value) {
                // Get the Project
    ...
    // Do Access Checks
    $context = $this->onActionDo($context, array('Read', 'Create', 'Update', 'Delete'), function($controller, $context, $action) {
              // Required Parameters
