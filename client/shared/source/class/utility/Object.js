 ...
 *
 */
qx.Bootstrap.define("utility.Object", {
  type : "static",
  ...
  statics : {
    ...
    /**
     * Creates an Object with a single property, based on incoming parameters
     *
     * @param property {String} Property Name
     * @param value {Var} Property Value
     * @return {Object}
     */
    singleProperty : function(property, value) {
      var object = {
      ...
      if (qx.lang.Type.isObject(object)) {
        ...
        if (qx.lang.Type.isArray(path) && (path.length > 0)) {
          ...
          for (var i = 0; parent && (i < (path.length - 1)); i++) {
            key = utility.String.nullOnEmpty(path[i]);
            if (key !== null) {
              if (!(key in parent)) {
                parent[key] = {
        ...
        // Set the value
        key = utility.String.nullOnEmpty(key);
    ...
    isInstanceOf : function(object, classname) {
      if (qx.lang.Type.isObject(object)) {
        // Climb Inheritance Chain - Looking for Match
