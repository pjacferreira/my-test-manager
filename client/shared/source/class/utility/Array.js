 ...
 *
 */
qx.Bootstrap.define("utility.Array", {
  type : "static",
  ...
  statics : {
     ...
     */
    union : function(a, b) {
      var dif = utility.Array.difference(a, b);
    ...
    trim : function(array) {
      if (array && (array.length > 0)) {
        ...
        return utility.Array.map(array, function(element, index, array) {
          return utility.String.v_nullOnEmpty(element, true);
        }, this);
      }
      return null;
    },
    ...
    CSVtoArray : function(value, seperator) {
      if (qx.lang.Type.isString(value)) {
        seperator = utility.String.v_nullOnEmpty(seperator, true);
