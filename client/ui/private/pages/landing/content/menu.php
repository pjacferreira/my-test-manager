...
<div id="sb_menu" class="ui left sidebar vertical pointing menu" style="overflow: hidden; background-color: green">
  <div class="item">
    ...
    <div class="pointing menu">
      <a name="login" class="item">
        <i class="sign in icon"></i><?php echo _("MENU:ACTION:LOGIN") ?>
      </a>
    </div>
  </div>
  <div class="item">
    ...
    <div class="pointing menu">
      <a name="use" class="item" href=<?php echo "'" . $this->url->get('page/institutional:use') . "'" ?> >
        <i class="content icon"></i><?php echo _("MENU:CONDITIONS:USE") ?>
      </a>
      <a name="privacy" class="item" href=<?php echo "'" . $this->url->get('page/institutional:privacy') . "'" ?> >
  ...
  <div class="item">
    ...
    <div class="pointing menu">
      <a name="contact" class="item" href=<?php echo "'" . $this->url->get('page/institutional:contact') . "'" ?> >
        <i class="mail icon"></i><?php echo _("MENU:US:CONTACT") ?>
      </a>
      <a name="about" class="item" href=<?php echo "'" . $this->url->get('page/institutional:about') . "'" ?> >
