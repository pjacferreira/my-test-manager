...
qx.Class.define("tc.metaform.Form",
  {
    ...
    members: {
      ...
      _applyModel: function (newModel, oldModel) {
        if (oldModel != null) {
          oldModel.removeListener("modelReady", this._buildForm, this);
          oldModel.removeListener("dataLoaded", this._refreshFields, this);
          oldModel.removeListener("dataSaved", this._formSaved, this);
          oldModel.removeListener("error", this._error, this);
        }

        newModel.addListener("modelReady", this._buildForm, this);
        newModel.addListener("dataLoaded", this._refreshFields, this);
        newModel.addListener("dataSaved", this._formSaved, this);
      ...
      __createFieldWidgets: function () {
        ...
        var factory = this.getWidgetFactory();
        ...
        if (values != null) {
          for (key in values) {
            if (values.hasOwnProperty(key) && this.__fieldWidgets.hasOwnProperty(key)) {
              this.__fieldWidgets[key].setValue(values[key]);
            }
          }
          ...
          for (key in this.__fieldWidgets) {
            if (this.__fieldWidgets.hasOwnProperty(key)) {
              ...
              if (value == null) {
                ...
                this.__fieldWidgets[key].setValue(value);
              }
            }
          }
        }
